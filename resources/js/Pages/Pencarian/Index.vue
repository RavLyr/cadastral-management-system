                    ...
                    <div v-if="selectedItem" class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-medium text-gray-900">{{ selectedItem.skala || '1:1000'
                                    }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ selectedItem.ipeda_r || '-'
                                        }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-500">IPEDA S</span>
                                    <span class="text-sm font-medium text-gray-900">{{ selectedItem.ipeda_s || '-'
                                        }}</span>
                                </div>
                                <div class="flex justify-between items-center">
